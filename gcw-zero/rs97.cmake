...
set(CMAKE_C_FLAGS "-DGCW0 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O2 -mips32  -mno-fp-exceptions -mno-check-zero-division -mframe-header-opt -fno-common -fno-PIC -mno-abicalls -mframe-header-opt -mno-fp-exceptions -mno-check-zero-division -static" CACHE STRING "Buildroot CFLAGS")
set(CMAKE_CXX_FLAGS "-DGCW0 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O2  -mips32  -mno-fp-exceptions -mno-check-zero-division -mframe-header-opt -fno-common -fno-PIC -mno-abicalls -mframe-header-opt -mno-fp-exceptions -mno-check-zero-division -static -static" CACHE STRING "Buildroot CXXFLAGS")
